...
import { getCourseNotice } from "@/components/classroom/data/course-notice-data";
import { getCourseLectureInfo } from "@/components/classroom/data/lecture-data";
import { CourseNoticeDetailBoard } from "@/components/classroom/CourseNoticeDetailBoard";
import { figma, figmaClass } from "@/components/home/home-design";
import { cn } from "@/lib/utils";

export function ClassroomNoticeDetailPage({ slug, id }: { slug: string; id: string }) {

...
/** 메인 보드 위젯 (좌·중 2열) */
export const adminBoardWidgets: AdminBoardWidget[] = [
  {
    id: "front-notice",
    title: "프론트 공지사항",
    href: "/admin/notices",
    items: [
      { title: "2026년 2학기 수강 안내", date: "2026-07-01" },
      { title: "시스템 점검 안내", date: "2026-06-28" },
      { title: "여름방학 특강 모집", date: "2026-06-25" },
    ],
  },
  {
    id: "class-notice",
    ...
    href: "/admin/notices",
    items: [
      { title: "중간고사 일정 공지", date: "2026-07-01" },
      { title: "과제 제출 기한 안내", date: "2026-06-30" },
    ],
  },
  {
    id: "consultation",
    title: "1:1 상담",
    href: "/admin/boards/consultation",
    items: [
      { title: "수강 상담 문의", date: "2026-07-01" },
      { title: "환불 관련 문의", date: "2026-06-29" },
    ],
  },
  {
    id: "class-qna",
    title: "강의실 질문게시판",
    href: "/admin/boards/free",
    items: [
      { title: "1차 과제 관련 질문", date: "2026-07-01" },
      { title: "시험 범위 문의", date: "2026-06-27" },
    ],
  },
  {
    id: "schedule",
    title: "일정안내",
    items: [
      { title: "7월 학사 일정", date: "2026-07-01" },
      { title: "자격증 시험 일정", date: "2026-06-26" },
    ],
  },
  {
    id: "student-monitor",
    ...
    href: "/admin/members",
    items: [
      { title: "미수강 학습자 3명", date: "2026-07-01" },
      { title: "진도율 50% 미만 5명", date: "2026-06-30" },
    ],
  },
  {
    id: "free-learning",
    title: "무료학습설계",
    items: [
      { title: "신규 학습설계 요청", date: "2026-07-01" },
      { title: "설계 완료 건", date: "2026-06-28" },
    ],
  },
];

/** 우측 통계 위젯 */
export const adminStatWidgets = [
  {
    id: "new-members",
    title: "신규회원",
    href: "/admin/members",

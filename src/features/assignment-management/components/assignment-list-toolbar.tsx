...
import { ASSIGNMENT_PUBLISH_FILTER_LABELS } from "@/features/assignment-management/constants";
import { buildAssignmentListQueryString } from "@/features/assignment-management/lib/assignment-list-query";
import type {
...
type AssignmentListToolbarProps = {
...
export function AssignmentListToolbar({
  ...
  function handleSearchSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    ) as AssignmentListQuery["publish"];

    startTransition(() => {
      router.push(
        `/admin/assignments${buildAssignmentListQueryString(
    ...
    >
      ...
      >
        ...
        >
          ...
          {Object.entries(ASSIGNMENT_PUBLISH_FILTER_LABELS).map(([value, label]) => (

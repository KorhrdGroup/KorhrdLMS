...
import { ClassroomNoticesPage } from "@/components/classroom/classroom-notices-page";
...
export default async function Page({ params }: PageProps) {
  ...
  if (!member) {
    redirect(`/login?redirect=/classroom/${slug}/notices`);
  }

  return <ClassroomNoticesPage slug={slug} />;
}

...
type CertificateApplicationsPageProps = {
  searchParams: Promise<Record<string, string | string[] | undefined>>;
};

export default async function CertificateApplicationsPage({
  searchParams,
}: CertificateApplicationsPageProps) {
  ...
  if (!result) {
    return (
      <div className="rounded-xl border border-[#E5E7EB] bg-white p-8 text-center shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
        <h1 className="text-lg font-bold text-[#111827]">발급신청</h1>
